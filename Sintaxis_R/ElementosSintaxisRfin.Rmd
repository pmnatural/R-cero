...
*summary* es una funcion muy util para describir un dataset de manera resumida. Por ejemplo, aplicado a un vector de caracteres: 
```{r}
v <- c("j", "k", "l")
summary(v)
```
...
Otra funcion importante para ver como es la estructura de un dataset es str(). Lo probamos tambien con iris.
