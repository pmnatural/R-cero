...
Si lo usamos con el dataset *iris* que tiene datos numéricos y viene ya con R 
```{r}
summary(iris)
```
...
Ahora unos [ejercicios] (https://github.com/pmnatural/R-cero/blob/master/Sintaxis_R/R0_Ejercicios1.html)
