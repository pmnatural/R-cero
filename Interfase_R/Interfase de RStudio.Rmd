...
```{r}
getwd() #dónde esta el directorio actual, donde estoy trabajando
...
```
Los paquetes quedan instalados para usar otras veces, pero para disponer de las funciones o datos en la sesion es necesario accederlas con  
