...
La pestaña *Packages* nos muestra los paquetes instalados, los que trajo R estan en *System Library*, los que instalados por el usuario (nosotros) en *User Library*. Si estan tildados es que esa librería ya esta cargada y sus funciones y datos estan disponibels para usar en la sesion actual.
...
setwd("c:/docs/mi_dir") #en windows, ojo que se usa / en vez de \  
setwd("/usr/rob/mi_dir") #en linux
```
...
En la pestaña *History* te aparece la lista de todos los comandos ejecutados durante la sesión o proyecto en marcha.
>>>>>>> 2e89d5a61aa0ebf62bcc7840502ee19b2b76fcde

Hay muchas frma de pedir ayuda en R y los resultados de ese pedido aparecen en la pestaña *Help*. Las principales instrucciones son las siguientes:
