...
Está basada en el libro de Roger Peng "Exploratory Data Analysis with R" con materiales traducidos por la RLady-BA Monica Alonso, la *cheatsheet* de [R Base](http://github.com/rstudio/cheatsheets/raw/master/base-r.pdf) de Mhari McNeill, la *cheatsheet* de Frans Van Dunné [Domar datos con R](https://www.rstudio.com/wp-content/uploads/2015/03/data-wrangling-spanish.pdf), en mini cursos que di años atrás y el testeo actual por la RLady-BA Fabi Flores. 

_________
## ¿Cómo seguimos?
En otros talleres continuaremos viendo temas especificos y empezaremos a usar un tipo de sintaxis más evolucionada, que se denomina *tidyverse*. Los cursos dados por Riva Quiroga y Laura Ación estan basados en este conjunto de paquetes, y si entediste ya lo basico de R (Interfase de RStudio y la variedad de objetos), podes ya largarte sola a seguirlos. En especial, es algunos meetups estaremos trabajando con el libro de Hadley Wickham [R for Data Science] (http://r4ds.had.co.nz/). 
